...
/* Nucleo 32 I/O */
	FILL_GPIO(THERM1,     GPIOB, 1, OUTPUT, LOW_SPEED, NONE, true, SENSOR)
	FILL_GPIO(THERM2,	  GPIOC, 14, OUTPUT, LOW_SPEED, NONE, true, SENSOR)
	...
	//SD
	FILL_GPIO(VOLT_SENSE, GPIOB, 0, OUTPUT, LOW_SPEED, NONE, true, SENSOR)
